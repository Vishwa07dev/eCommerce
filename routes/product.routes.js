...
const { authJwt, requestValidator, checkDuplicateProduct } = require("../middlewares");
...
module.exports = function (app) {
    ...
    app.put("/ecomm/api/v1/products/:id", [authJwt.verifyToken, authJwt.isAdmin, requestValidator.validateProductRequest, checkDuplicateProduct.checkDuplicateProduct], productController.update);
